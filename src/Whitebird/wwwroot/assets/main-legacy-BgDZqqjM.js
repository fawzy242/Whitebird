System.register(['./vendor-legacy-BxKEvg5G.js'], function (e, t) {
  'use strict';
  var a;
  return {
    setters: [
    ...
    execute: function () {
      ...
      const t = 'auth_token',
        ...
        o = new (class {
          ...
          setItem(e, t, a = !1) {
            try {
              const r = this.getPrefixedKey(e),
                n = JSON.stringify(t);
              return (a ? this.sessionStorage.setItem(r, n) : this.storage.setItem(r, n), !0);
            } catch (r) {
              return !1;
            }
          }
          getItem(e, t = !1) {
            try {
              const a = this.getPrefixedKey(e),
                r = t ? this.sessionStorage.getItem(a) : this.storage.getItem(a);
          ...
          removeItem(e, t = !1) {
            try {
              const a = this.getPrefixedKey(e);
              return (t ? this.sessionStorage.removeItem(a) : this.storage.removeItem(a), !0);
            } catch (a) {
              return !1;
            }
          }
          ...
          getStorageSize(e = !1) {
            ...
            let a = 0;
            for (let r in t)
              t.hasOwnProperty(r) && r.startsWith(this.prefix) && (a += t[r].length + r.length);
            return a;
          }
          setToken(e) {
          ...
          removeRefreshToken() {
            return this.removeItem(r);
          }
          setCsrfToken(e) {
            return this.setItem(n, e, !0);
          }
          getCsrfToken() {
        ...
        l = new (class {
          ...
          setupRequestInterceptor() {
            this.axiosInstance.interceptors.request.use(
              (e) => {
                ...
                const a = o.getCsrfToken();
                return (
                  a && (e.headers['X-CSRF-Token'] = a),
                ...
                if (401 === e.response.status && !t._retry) {
                  if (this.isRefreshing)
                    return new Promise((e, t) => {
                      ...
                      .then(
                        (e) => ((t.headers.Authorization = `Bearer ${e}`), this.axiosInstance(t))
                      )
                  ...
                  try {
                    ...
                    return (
                      (this.isRefreshing = !1),
                      this.processQueue(a, null),
                      o.clearAuth(),
                      s.emit('auth:session-expired'),
                      Promise.reject(a)
                    );
                  }
                }
                return (
                  403 === e.response.status && s.emit('api:forbidden', e.response),
                  404 === e.response.status && s.emit('api:not-found', e.response),
                  e.response.status >= 500 && s.emit('api:server-error', e.response),
          ...
          async refreshToken() {
            ...
            const t = await a.post(`${d}/auth/refresh`, { refresh_token: e }),
              { token: r, refresh_token: n } = t.data;
            return (o.setToken(r), o.setRefreshToken(n), r);
          }
          normalizeError(e) {
            return e.response
              ? {
          ...
          async post(e, t = {}, a = {}) {
            try {
              return (await this.axiosInstance.post(e, t, a)).data;
            } catch (r) {
              throw r;
            }
          }
          async put(e, t = {}, a = {}) {
            try {
              return (await this.axiosInstance.put(e, t, a)).data;
            } catch (r) {
              throw r;
            }
          }
          async patch(e, t = {}, a = {}) {
            try {
              return (await this.axiosInstance.patch(e, t, a)).data;
            } catch (r) {
              throw r;
            }
          }
          ...
          async uploadFile(e, t, a = null) {
            ...
            try {
              return (await this.axiosInstance.post(e, r, n)).data;
            } catch (i) {
              throw i;
            }
          }
          async downloadFile(e, t) {
            try {
              const a = await this.axiosInstance.get(e, { responseType: 'blob' }),
                r = new Blob([a.data]),
          ...
          cancelPendingRequests() {
            s.emit('api:requests-canceled');
          }
          getInstance() {
            return this.axiosInstance;
          }
        })(),
        c = 'testuser@redadmin.local',
        m = 'Test@1234',
        h = new (class {
          constructor() {
          ...
          init() {
            ...
            e &&
              ...
              s.emit('auth:initialized', { user: t }));
          }
          async login(e, t, a = !1) {
            try {
              if (e === c && t === m) return this.handleTestAccountLogin(a);
              const r = await l.post('/auth/login', { username: e, password: t, remember_me: a });
              return this.handleLoginSuccess(r, a);
            } catch (r) {
              throw (s.emit('auth:login-failed', r), r);
            }
          }
          handleTestAccountLogin(e) {
            const t = {
              ...
              a = 'test_token_' + Date.now(),
              r = 'test_refresh_' + Date.now();
            return (
              o.setToken(a),
              o.setRefreshToken(r),
              o.setUser(t),
              ...
              (this.isAuthenticated = !0),
              this.startTokenExpiryCheck(),
              s.emit('auth:login-success', { user: t, isTestAccount: !0 }),
              { success: !0, user: t, token: a, message: 'Test account login successful' }
            );
          }
          handleLoginSuccess(e, t) {
            const { token: a, refresh_token: r, user: n } = e;
            return (
              o.setToken(a),
              o.setRefreshToken(r),
              o.setUser(n),
              ...
              (this.isAuthenticated = !0),
              this.startTokenExpiryCheck(),
              s.emit('auth:login-success', { user: n }),
              { success: !0, user: n, token: a }
            );
          }
          async logout() {
            try {
              ...
              (this.clearAuthData(), s.emit('auth:logout'));
            }
          }
          async register(e) {
            try {
              const t = await l.post('/auth/register', e);
              return (s.emit('auth:register-success', t), t);
            } catch (t) {
              throw (s.emit('auth:register-failed', t), t);
            }
          }
          async forgotPassword(e) {
            try {
              const t = await l.post('/auth/forgot-password', { email: e });
              return (s.emit('auth:forgot-password-sent', { email: e }), t);
            } catch (t) {
              throw (s.emit('auth:forgot-password-failed', t), t);
            }
          }
          async resetPassword(e, t) {
            try {
              const a = await l.post('/auth/reset-password', { token: e, password: t });
              return (s.emit('auth:password-reset-success'), a);
            } catch (a) {
              throw (s.emit('auth:password-reset-failed', a), a);
            }
          }
          async changePassword(e, t) {
            try {
              const a = await l.post('/auth/change-password', {
                current_password: e,
                new_password: t,
              });
              return (s.emit('auth:password-changed'), a);
            } catch (a) {
              throw a;
            }
          }
          async refreshToken() {
            try {
              ...
              throw (this.clearAuthData(), s.emit('auth:session-expired'), e);
            }
          }
          getCurrentUser() {
          ...
          updateCurrentUser(e) {
            ((this.currentUser = { ...this.currentUser, ...e }),
              ...
              s.emit('auth:user-updated', this.currentUser));
          }
          checkAuth() {
            const e = o.getToken(),
              t = o.getUser();
          ...
          hasPermission(e) {
            ...
            return !!t && (!!t.permissions?.includes('*') || t.permissions?.includes(e) || !1);
          }
          hasRole(e) {
            const t = this.getCurrentUser();
            return t?.role === e;
          ...
          startTokenExpiryCheck() {
            (this.stopTokenExpiryCheck(),
              (this.tokenExpiryTimer = setInterval(() => {
                this.checkAuth() || (this.clearAuthData(), s.emit('auth:session-expired'));
              }, 3e5)));
          }
          stopTokenExpiryCheck() {
            this.tokenExpiryTimer &&
              (clearInterval(this.tokenExpiryTimer), (this.tokenExpiryTimer = null));
          }
          lockScreen() {
            (o.setTempData('screen_locked', !0), s.emit('auth:screen-locked'));
          }
          async unlockScreen(e) {
            try {
              const t = this.getCurrentUser();
              if (this.isTestAccount() && e === m)
                return (
                  o.removeTempData('screen_locked'),
                  s.emit('auth:screen-unlocked'),
                  { success: !0 }
                );
              const a = await l.post('/auth/unlock', { user_id: t.id, password: e });
              return (o.removeTempData('screen_locked'), s.emit('auth:screen-unlocked'), a);
            } catch (t) {
              throw t;
            }
          }
      ...
      class u {
        static createElement(e, t = {}, a = '') {
          ...
          return (
            Object.entries(t).forEach(([e, t]) => {
              if ('className' === e) r.className = t;
              else if ('dataset' === e)
                Object.entries(t).forEach(([e, t]) => {
                  r.dataset[e] = t;
                });
              else if (e.startsWith('on')) {
                const a = e.substring(2).toLowerCase();
                r.addEventListener(a, t);
              } else r.setAttribute(e, t);
            }),
            a &&
              ('string' == typeof a ? (r.textContent = a) : a instanceof Node && r.appendChild(a)),
            r
          );
        }
        ...
        static insertHTML(e, t, a = 'beforeend') {
          const r = document.createElement('template');
          switch (((r.innerHTML = t.trim()), a)) {
            case 'beforebegin':
              e.parentNode.insertBefore(r.content, e);
              break;
            case 'afterbegin':
              e.insertBefore(r.content, e.firstChild);
              break;
            case 'beforeend':
              e.appendChild(r.content);
              break;
            case 'afterend':
              e.parentNode.insertBefore(r.content, e.nextSibling);
          }
        }
        static remove(e) {
          e && e.parentNode && e.parentNode.removeChild(e);
        }
        static toggleClass(e, t, a) {
          void 0 !== a ? e.classList.toggle(t, a) : e.classList.toggle(t);
        }
        static getOffset(e) {
        ...
        static waitForElement(e, t = 5e3) {
          return new Promise((a, r) => {
            ...
            (i.observe(document.body, { childList: !0, subtree: !0 }),
              setTimeout(() => {
                (i.disconnect(), r(new Error(`Element ${e} not found within ${t}ms`)));
              }, t));
          });
        }
      ...
      const g = new (class {
          ...
          navigate(e, t = !0) {
            ...
            ('boolean' == typeof t
              ? (a = t)
              : 'object' == typeof t && ((a = !1 !== t.pushState), (r = t.id || null)),
              r && sessionStorage.setItem('crudId', r),
              a && window.history.pushState({ path: e }, '', `/${e}`),
              this.loadRoute(e));
          }
          async loadRoute(e, t = !0) {
            const a = this.routes.get(e);
            if (a)
              if (!a.requiresAuth && h.checkAuth() && this.authPages.includes(e))
                this.navigate(this.defaultRoute, t);
              else {
                s.emit('app:loading', !0);
                try {
                  ('auth' === a.layout ? this.showAuthLayout() : this.showDefaultLayout(),
                    await this.loadTemplate(a.template),
                    (document.title = `${a.title} - RedAdmin Pro`),
                    this.updateActiveMenu(e),
                    (this.currentRoute = e),
                    a.onEnter && (await a.onEnter()),
                    s.emit('route:changed', { path: e, route: a }));
                } catch (r) {
                  s.emit('app:error', r);
                } finally {
                  s.emit('app:loading', !1);
                }
              }
          ...
          async loadTemplate(e) {
            try {
              ...
              if (!t.ok) throw new Error(`Failed to load template: ${t.status}`);
              const a = await t.text(),
                r = document.getElementById('pageContent');
              r &&
                ((r.innerHTML = a),
          ...
          showAuthLayout() {
            ...
            (e && (e.style.display = 'none'),
              ...
              a && ((a.style.marginLeft = '0'), (a.style.marginTop = '0')),
          ...
          showDefaultLayout() {
            ...
            (e && (e.style.display = 'flex'),
              ...
              a && ((a.style.marginLeft = ''), (a.style.marginTop = '')),
          ...
          updateActiveMenu(e) {
            ...
            const t = document.querySelector(`[data-route="${e}"]`);
        ...
        p = new (class {
          ...
          loadPersistedState() {
            const e = o.getUser(),
              ...
              a = o.getItem('sidebar_collapsed') || !1,
              r = o.getItem('settings') || {};
            this.state = { ...this.state, user: e, theme: t, sidebarCollapsed: a, settings: r };
          }
          get(e) {
            return this.state[e];
          }
          set(e, t, a = !1) {
            ...
            ((this.state[e] = t),
              a && o.setItem(e, t),
              this.notify(e, t, r),
              s.emit('state:changed', { key: e, value: t, oldValue: r }));
          }
          update(e, t = !1) {
          ...
          cacheData(e, t, a = 36e5) {
            const r = this.get('cache');
            ((r[e] = { data: t, timestamp: Date.now(), ttl: a }), this.set('cache', r));
          }
          getCachedData(e) {
            const t = this.get('cache'),
              a = t[e];
            return a
              ? Date.now() - a.timestamp > a.ttl
                ? (delete t[e], this.set('cache', t), null)
                : a.data
              : null;
          }
          clearCache() {
        ...
        f = new (class {
          ...
          show(e, t, a = {}) {
            const r = { duration: 5e3, dismissible: !0, icon: !0, ...a },
              n = 'toast-' + Date.now(),
            ...
            u.insertHTML(this.container, o);
            const s = document.getElementById(n),
              d = new bootstrap.Toast(s, { delay: r.duration });
            return (
              d.show(),
      ...
      class v {
        ...
        createFooter() {
          return 0 === this.options.buttons.length
            ? '\n        <div class="modal-footer">\n          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>\n        </div>\n      '
            : `<div class="modal-footer">${this.options.buttons
                .map((e) => {
                  const t = e.className || 'btn-primary',
                    a = e.dismiss ? 'data-bs-dismiss="modal"' : '';
        ...
        setupEventListeners() {
          (this.modal.addEventListener('show.bs.modal', () => {
            ((this.isVisible = !0),
              ...
              s.emit('modal:show', { id: this.options.id }));
          }),
            this.modal.addEventListener('hide.bs.modal', () => {
              ((this.isVisible = !1),
                this.options.onHide && this.options.onHide(this),
                s.emit('modal:hide', { id: this.options.id }));
            }),
            this.modal.addEventListener('hidden.bs.modal', () => {
              s.emit('modal:hidden', { id: this.options.id });
            }),
            this.options.buttons.forEach((e) => {
              if (e.action && e.onClick) {
                const t = this.modal.querySelector(`[data-action="${e.action}"]`);
        ...
        w = new (class {
          ...
          renderMessage(e) {
            const t = e.unread ? 'unread' : '',
              a = e.avatar || 'https://via.placeholder.com/40';
          ...
          setupInboxHandlers() {
            ...
            (t &&
              ...
              u.on(e, 'click', '.inbox-message', (e) => {
                const t = e.currentTarget.dataset.messageId;
                this.openMessage(t);
              }),
              u.on(e, 'click', '.page-link', (e) => {
          ...
          handleSearch(e) {
            s.emit('inbox:search', { query: e });
          }
          openMessage(e) {
            const t = this.messages.find((t) => t.id == e);
            t &&
              ((t.unread = !1),
              s.emit('inbox:message-opened', { message: t }),
              s.emit('notification:info', `Opening message from ${t.from}`));
          }
          updateInbox() {
          ...
          generateSampleMessages() {
            ...
            for (let t = 1; t <= 25; t++)
              e.push({
                id: t,
                from: `User ${t}`,
                subject: `Message Subject ${t}`,
                preview: `This is a preview of message ${t}...`,
                time: `${t} hours ago`,
                unread: t <= 5,
                avatar: null,
              });
        ...
        x = new (class {
          ...
          setupEventListeners() {
            ...
            (e &&
              ...
              document.addEventListener('click', (e) => {
                const a = e.target.closest('.quick-link-item');
                if (a && (e.preventDefault(), a.dataset.page)) {
                  const e = bootstrap.Modal.getInstance(t);
                  (e && e.hide(), (window.location.href = a.href));
                }
              }),
              document.addEventListener('click', (e) => {
                const a = e.target.closest('.search-result-item');
                if (a && (e.preventDefault(), a.dataset.page)) {
                  this.addToRecent(a.textContent.trim());
                  const e = bootstrap.Modal.getInstance(t);
                  (e && e.hide(), (window.location.href = a.dataset.path));
                }
              }));
          }
          performSearch(e) {
            const t = document.getElementById('resultsSection'),
              a = document.getElementById('recentSection'),
              r = document.getElementById('noResults');
            if (!e) return void this.showRecent();
            const n = this.pages.filter(
              (t) =>
                t.name.toLowerCase().includes(e.toLowerCase()) ||
                t.category.toLowerCase().includes(e.toLowerCase())
            );
            if (((a.style.display = 'none'), n.length > 0)) {
              ((r.style.display = 'none'), (t.style.display = 'block'));
              const e = n
                .map(
                  (e) =>
            ...
            } else ((t.style.display = 'none'), (r.style.display = 'block'));
          }
          showRecent() {
              ...
              t &&
                ...
                setTimeout(() => {
                  ...
                  e.classList.contains('open')
                    ? (e.classList.remove('open'), a.classList.remove('show'))
                    : (document.querySelectorAll('.sidebar-menu .has-submenu').forEach((t) => {
                        t !== e &&
                          (t.classList.remove('open'),
                          t.querySelector('.submenu')?.classList.remove('show'));
                      }),
      ...
      const k = new (class {
        ...
        loadNotifications() {
          return [
            ...
            },
            {
              ...
              title: 'System Update',
              message:
                'A new system update is available. Please update to get the latest features.',
              time: '1 hour ago',
              read: !1,
            },
            {
              ...
              message:
                'Your storage is almost full. Consider upgrading your plan or removing old files.',
              time: '2 hours ago',
              read: !0,
            },
            {
        ...
        refresh() {
          ...
          (e && (e.innerHTML = this.renderNotifications()),
            t && (t.textContent = this.getUnreadCount()));
        }
        getUnreadCount() {
        ...
        refresh() {
          ...
          const a = document.querySelector('.topbar-icon .notification-badge');
          if (a) {
            const e = this.getUnreadCount();
            ((a.textContent = e), (a.style.display = e > 0 ? 'flex' : 'none'));
          }
        }
      })();
      'undefined' != typeof window && (window.notificationModal = k);
      const E = new (class {
          constructor() {
          ...
          show(e = {}) {
            ...
            return new Promise((e) => {
              ...
              const s = document.getElementById('confirmIcon'),
                d = document.getElementById('confirmOk'),
                l = document.getElementById('confirmCancel');
              let c = '',
                m = '';
              switch (t) {
                case 'success':
                  ((c = '<i class="fas fa-check-circle fa-4x"></i>'),
                    (m = 'text-success'),
                    (d.className = 'btn btn-success px-4'),
                    (l.style.display = 'none'));
                  break;
                case 'error':
                  ((c = '<i class="fas fa-times-circle fa-4x"></i>'),
                    (m = 'text-danger'),
                    (d.className = 'btn btn-danger px-4'),
                    (d.textContent = 'OK'),
                    (l.style.display = 'none'));
                  break;
                case 'warning':
                  ((c = '<i class="fas fa-exclamation-triangle fa-4x"></i>'),
                    (m = 'text-warning'),
                    (d.className = 'btn btn-warning px-4'),
                    (l.style.display = 'inline-block'));
                  break;
                case 'delete':
                  ((c = '<i class="fas fa-trash-alt fa-4x"></i>'),
                    (m = 'text-danger'),
                    (d.className = 'btn btn-danger px-4'),
                  ...
                  break;
                case 'info':
                  ((c = '<i class="fas fa-info-circle fa-4x"></i>'),
                    (m = 'text-info'),
                    (d.className = 'btn btn-info px-4'),
                    (l.style.display = 'none'));
                  break;
                default:
                  ((c = '<i class="fas fa-question-circle fa-4x"></i>'),
                    (m = 'text-primary'),
                    (d.className = `btn ${o} px-4`),
                    (l.style.display = 'inline-block'));
              }
              ((s.innerHTML = c),
                (s.className = `confirm-icon mb-3 ${m}`),
                (document.getElementById('confirmTitle').textContent = a),
                (document.getElementById('confirmMessage').textContent = r),
                (d.textContent = n),
                (l.textContent = i),
        ...
        I = Object.freeze(
          Object.defineProperty({ __proto__: null, confirmModal: E }, Symbol.toStringTag, {
            value: 'Module',
          })
        ),
      ...
      const S = new (class {
        ...
        hideInline(e) {
          ...
          if (!t) return;
          const a = t.querySelector('.inline-spinner');
          a && a.remove();
        }
      })();
      'undefined' != typeof window && (window.loadingSpinner = S);
      const T = new (class {
        show(e, t = {}) {
          const a = {
              icon: 'fa-inbox',
          ...
          if (n && ((n.innerHTML = r), a.action)) {
            const e = document.getElementById('emptyStateAction');
            e && e.addEventListener('click', a.action.onclick);
          }
        }
        hide(e) {
          const t = document.querySelector(e);
      ...
      ('undefined' != typeof window && (window.emptyState = T),
        (function () {
          function e() {
            document
          ...
          if (
            ((window.togglePasswordVisibility = function (e) {
              ...
              if (!a) return;
              const r = e.querySelector('i') || e.querySelector('.fa-eye, .fa-eye-slash');
              'password' === a.type
                ? ((a.type = 'text'),
                  r && (r.classList.remove('fa-eye'), r.classList.add('fa-eye-slash')))
                : ((a.type = 'password'),
                  r && (r.classList.remove('fa-eye-slash'), r.classList.add('fa-eye')));
            }),
      ...
      const L = new (class {
          ...
          setupEventListeners() {
            ...
            const a = document.querySelectorAll('[data-period]');
            a.forEach((e) => {
            ...
            if (e) {
              ...
              ((e.innerHTML = '<i class="fas fa-spinner fa-spin me-2"></i>Exporting...'),
                ...
                setTimeout(() => {
                  ...
                  ((a.href = '#'), (a.download = 'dashboard-report.pdf'), a.click());
                }, 1500));
            }
          }
      ...
      'undefined' != typeof window && (window.API_CONFIG = A);
      const z = new (class {
        constructor() {
        ...
        getHeaders(e = !0) {
          ...
          return (e && this.token && (t.Authorization = `Bearer ${this.token}`), t);
        }
        async request(e, t = {}) {
          const a = this.buildURL(e);
          this.debug;
          const r = {
            method: t.method || 'GET',
          ...
          t.body && 'object' == typeof t.body && (r.body = JSON.stringify(t.body));
          try {
            const e = await fetch(a, r),
              t = e.headers.get('content-type');
            let n;
            if (
              (t && t.includes('application/json')
                ? (n = await e.json())
                : ((n = await e.text()), this.debug),
              !e.ok)
            ) {
              const t = n?.message || n?.error || `API request failed with status ${e.status}`;
              throw (this.debug, new Error(t));
            }
            return (this.debug, n);
          } catch (n) {
            throw (this.debug, new Error(`API request failed: ${n.message}`));
          }
        }
        async login(e, t) {
          const a = await this.request('/api/auth/login', {
            method: 'POST',
            auth: !1,
            body: { email: e, password: t },
          });
          if (a.isSuccess && a.data) return (this.setToken(a.data.token), this.debug, a.data);
          throw new Error(a.message || 'Login failed');
        }
        async getMe() {
        ...
        async resetPassword(e, t, a) {
          return await this.request('/api/auth/reset-password', {
            method: 'POST',
            auth: !1,
            body: { email: e, token: t, newPassword: a },
          });
        }
        async getAssetsGrid(e = {}) {
          const t = new URLSearchParams(e).toString();
          return (await this.request(`/api/asset/grid?${t}`)).data;
        }
        async getAssets() {
          return (await this.request('/api/asset')).data;
        }
        async getAsset(e) {
          return (await this.request(`/api/asset/${e}`)).data;
        }
        async createAsset(e) {
          return await this.request('/api/asset', { method: 'POST', body: e });
        }
        async updateAsset(e, t) {
          return await this.request(`/api/asset/${e}`, { method: 'PUT', body: t });
        }
        async deleteAsset(e) {
          return await this.request(`/api/asset/${e}`, { method: 'DELETE' });
        }
        async getEmployeesGrid(e = {}) {
          const t = new URLSearchParams(e).toString();
          return (await this.request(`/api/employee/grid?${t}`)).data;
        }
        async getEmployees() {
        ...
        async getEmployee(e) {
          return (await this.request(`/api/employee/${e}`)).data;
        }
        async createEmployee(e) {
          return await this.request('/api/employee', { method: 'POST', body: e });
        }
        async updateEmployee(e, t) {
          return await this.request(`/api/employee/${e}`, { method: 'PUT', body: t });
        }
        async deleteEmployee(e) {
          return await this.request(`/api/employee/${e}`, { method: 'DELETE' });
        }
        async getCategories() {
        ...
        async getCategory(e) {
          return (await this.request(`/api/category/${e}`)).data;
        }
        async createCategory(e) {
          return await this.request('/api/category', { method: 'POST', body: e });
        }
        async updateCategory(e, t) {
          return await this.request(`/api/category/${e}`, { method: 'PUT', body: t });
        }
        async deleteCategory(e) {
          return await this.request(`/api/category/${e}`, { method: 'DELETE' });
        }
        async getTransactions() {
          return (await this.request('/api/assettransactions')).data;
        }
        async getTransactionsByAsset(e) {
          return (await this.request(`/api/assettransactions/asset/${e}`)).data;
        }
        async getTransaction(e) {
          return (await this.request(`/api/assettransactions/${e}`)).data;
        }
        async createTransaction(e) {
          return await this.request('/api/assettransactions', { method: 'POST', body: e });
        }
        async updateTransaction(e, t) {
          return await this.request(`/api/assettransactions/${e}`, { method: 'PUT', body: t });
        }
        async deleteTransaction(e) {
          return await this.request(`/api/assettransactions/${e}`, { method: 'DELETE' });
        }
        async checkHealth() {
        ...
        async testConnection() {
          try {
            return (await this.checkHealth(), !0);
          } catch (e) {
            return !1;
          }
        }
      ...
      'undefined' != typeof window &&
        ((window.whitebirdAPI = z),
        (window.debugAPI = {
          test: () => z.testConnection(),
          getBaseURL: () => z.getCurrentBaseURL(),
          getToken: () => z.token,
          clearToken: () => z.setToken(null),
      ...
      const B = new (class {
          ...
          async create(e) {
            try {
              ...
              if ((this.validate(e), this.useAPI)) {
                const a = await z.createEmployee(e);
                if (!(a && a.success && a.data)) throw new Error('API returned no data');
                ((t = a.data), this.employees.push(t));
              } else
              ...
              return (await E.success('Success!', 'Employee added successfully!'), t);
            } catch (t) {
              throw (await E.error('Error!', t.message || 'Failed to add employee'), t);
            }
          }
          getAll() {
          ...
          filter(e) {
            ...
            if (e.search) {
              ...
              t = t.filter(
                (e) =>
                  e.firstName.toLowerCase().includes(a) ||
                  e.lastName.toLowerCase().includes(a) ||
                  e.email.toLowerCase().includes(a) ||
                  e.id.toLowerCase().includes(a) ||
                  e.department.toLowerCase().includes(a) ||
                  e.position.toLowerCase().includes(a)
              );
            }
            return (
          ...
          async update(e, t) {
            try {
              const a = this.employees.findIndex((t) => t.id === e);
              if (-1 === a) throw new Error('Employee not found');
              let r;
              if ((this.validate(t), this.useAPI)) {
                const n = await z.updateEmployee(e, t);
                if (!(n && n.success && n.data)) throw new Error('API returned no data');
                ((r = n.data), (this.employees[a] = r));
              } else
                (await this.mockApiCall(),
                  (r = { ...this.employees[a], ...t, updatedAt: new Date().toISOString() }),
                  (this.employees[a] = r));
              return (await E.success('Success!', 'Employee updated successfully!'), r);
            } catch (a) {
              throw (await E.error('Error!', a.message || 'Failed to update employee'), a);
            }
          }
          async delete(e) {
            try {
              ...
              if (
                !(await E.delete(
                  'Delete Employee',
                  `Are you sure you want to delete ${t.firstName} ${t.lastName}? This action cannot be undone.`
                ))
              )
                return !1;
              if (this.useAPI) {
                const t = await z.deleteEmployee(e);
                if (!t || !t.success) throw new Error('API delete failed');
                this.employees = this.employees.filter((t) => t.id !== e);
              } else
                (await this.mockApiCall(),
                  (this.employees = this.employees.filter((t) => t.id !== e)));
              return (await E.success('Deleted!', 'Employee deleted successfully!'), !0);
            } catch (t) {
              throw (await E.error('Error!', t.message || 'Failed to delete employee'), t);
            }
          }
          async exportToCSV(e = null) {
            try {
              const t = e || this.employees,
                a = this.generateCSV(t),
                r = new Blob([a], { type: 'text/csv;charset=utf-8;' }),
                n = window.URL.createObjectURL(r),
                i = document.createElement('a');
              ((i.href = n),
                (i.download = `employees_export_${new Date().toISOString().split('T')[0]}.csv`),
                i.click(),
                window.URL.revokeObjectURL(n),
                await E.success('Exported!', `${t.length} employee(s) exported successfully!`));
            } catch (t) {
              throw (await E.error('Error!', 'Failed to export employees'), t);
            }
          }
          generateCSV(e) {
            return [
          ...
          validate(e) {
            ...
            for (const a of t) if (!e[a]) throw new Error(`${a} is required`);
          ...
          generateId() {
            const e = this.employees.reduce((e, t) => {
              const a = parseInt(t.id.replace('EMP', ''));
              return a > e ? a : e;
            }, 0);
            return `EMP${String(e + 1).padStart(3, '0')}`;
          }
          async mockApiCall() {
        ...
        D = new (class {
          ...
          async loadEmployees() {
            try {
              this.loading = !0;
              const e = await z.getEmployeesGrid({ page: 1, pageSize: 1e3 });
              e && e.success && e.data && B.setEmployees(e.data);
            } catch (e) {
            } finally {
              this.loading = !1;
            }
          ...
          setupEventListeners() {
                ...
                try {
                  (await this.loadEmployees(),
                    ...
                    window.showNotification &&
                      window.showNotification(
                        'success',
                        '✅ Employees refreshed successfully from API'
                      ));
                } catch (e) {
                  window.showNotification &&
                    window.showNotification('danger', '❌ Failed to refresh employees');
                } finally {
                  ((t.innerHTML = '<i class="fas fa-sync-alt me-2"></i>Refresh'),
                    (t.disabled = !1));
                }
              });
            const a = document.getElementById('btnExportExcel');
            a && a.addEventListener('click', () => this.handleExport());
            const r = document.getElementById('searchEmployee');
            if (r) {
              let e;
            ...
            const n = document.getElementById('filterDepartment'),
            ...
            const s = document.getElementById('approved-tab'),
              d = document.getElementById('pending-tab');
            (s &&
              s.addEventListener('shown.bs.tab', () => {
                ((this.currentTab = 'approved'), (this.currentPage = 1), this.renderCurrentTab());
              }),
              d &&
                d.addEventListener('shown.bs.tab', () => {
          ...
          async handleDelete(e) {
            const t = B.getById(e);
            t &&
              confirm(`Delete employee "${t.name}"?\n\nThis action cannot be undone.`) &&
              B.delete(e) &&
              this.loadAndRender();
          }
          loadAndRender() {
          ...
          applyFilters() {
            const e = document.getElementById('searchEmployee')?.value.toLowerCase() || '',
              t = document.getElementById('filterDepartment')?.value || '',
              a = document.getElementById('filterSalary')?.value || '';
            let r = B.getAll();
            if (
              (e &&
                (r = r.filter(
              ...
              t && (r = r.filter((e) => e.department === t)),
              a)
            )
              if ('100000+' === a) r = r.filter((e) => e.salary >= 1e5);
              else {
                const [e, t] = a.split('-').map(Number);
                r = r.filter((a) => a.salary >= e && a.salary < t);
              }
            ((this.filteredData = r), (this.currentPage = 1), this.renderCurrentTab());
          }
          resetFilters() {
          ...
          renderTable(e, t, a) {
            ...
            if (0 === a.length)
              return (
                ...
                void r.parentElement.parentElement.classList.add('d-none')
              );
            (n?.classList.add('d-none'), r.parentElement.parentElement.classList.remove('d-none'));
            ...
            (s.forEach((e, t) => {
              ...
              (r.innerHTML = ''),
              r.appendChild(d),
              this.renderPagination(a.length));
          }
          renderPagination(e) {
            const t = document.getElementById('pagination');
            if (!t) return;
            const a = Math.ceil(e / this.pageSize);
            if (a <= 1) return void (t.innerHTML = '');
            let r = '';
            r += `\n            <li class="page-item ${1 === this.currentPage ? 'disabled' : ''}">\n                <a class="page-link" href="#" onclick="window.employeesMenuInstance.goToPage(${this.currentPage - 1}); return false;">\n                    <i class="fas fa-chevron-left"></i>\n                </a>\n            </li>\n        `;
            let n = Math.max(1, this.currentPage - Math.floor(2.5)),
              i = Math.min(a, n + 5 - 1);
            i - n < 4 && (n = Math.max(1, i - 5 + 1));
            for (let o = n; o <= i; o++)
          ...
          updateCounts() {
            const e =
              ...
              a = Math.min(this.currentPage * this.pageSize, e.length);
      ...
      'undefined' != typeof window && (window.employeesMenuInstance = D);
      const M = new (class {
          constructor() {
          ...
          setupEventListeners() {
            ...
            const t = document.getElementById('btnCancelEmployee'),
              a = document.getElementById('btnBackToEmployees');
            e &&
          ...
          async handleSubmit() {
            ...
            try {
              ...
              if (
                ...
                (a =
                  'update' === this.mode
                    ? await z.updateEmployee(this.employeeId, t)
                    : await z.createEmployee(t)),
                !a || !a.success)
              )
                throw new Error(a.message || 'Failed to save employee');
              (alert(
                'update' === this.mode
        ...
        P = new (class {
          ...
          async loadFromAPI() {
            try {
              ...
              const e = await z.getAssetsGrid({ page: 1, pageSize: 1e3 });
              e && e.success && e.data
          ...
          async loadCategories() {
            try {
              const e = await z.getActiveCategories();
              e && e.success && e.data
          ...
          generateSampleAssets() {
            const e = {
              ...
              a = ['John Doe', 'Jane Smith', 'Bob Johnson', 'Alice Williams'],
              r = ['Screen broken', 'Battery replacement', 'Software update', 'Hardware check'];
            let n = [],
              i = 1;
            return (
                ...
                e[o].forEach((e) => {
                  const s = t[Math.floor(Math.random() * t.length)],
                    d = {
                      id: i++,
                      name: e,
                      code: `AST-${String(i).padStart(4, '0')}`,
                      category: o,
                      status: s,
                      purchaseDate: this.randomDate(),
                      value: Math.floor(5e3 * Math.random()) + 500,
                      assignedTo: 'In Use' === s ? a[Math.floor(Math.random() * a.length)] : null,
                      assignedDate: 'In Use' === s ? this.randomDate() : null,
                      issue: 'Maintenance' === s ? r[Math.floor(Math.random() * r.length)] : null,
                      maintenanceDate: 'Maintenance' === s ? this.randomDate() : null,
                    };
                  n.push(d);
                });
              }),
          ...
          setupEventListeners() {
                ...
                try {
                  (await this.loadFromAPI(),
                    ...
                    window.showNotification &&
                      window.showNotification(
                        'success',
                        '✅ Assets refreshed successfully from API'
                      ));
                } catch (e) {
                  window.showNotification &&
            ...
            const a = document.getElementById('searchAssets');
            if (a) {
              let e;
            ...
            const r = document.getElementById('filterCategory'),
              n = document.getElementById('filterStatus');
            ...
            const o = document.getElementById('availableTab'),
              s = document.getElementById('inuseTab'),
              d = document.getElementById('maintenanceTab');
            (o &&
          ...
          applyFilters() {
            const e = document.getElementById('searchAssets')?.value.toLowerCase() || '',
              t = document.getElementById('filterCategory')?.value || '',
              a = document.getElementById('filterStatus')?.value || '';
            ((this.filteredData = this.assets.filter((r) => {
              let n = !0;
              return (
                e &&
                  (n =
                    ...
                    (r.name.toLowerCase().includes(e) ||
                      r.code.toLowerCase().includes(e) ||
                      r.category.toLowerCase().includes(e))),
                t && (n = n && r.category === t),
                a && (n = n && r.status === a),
                n
              );
              ...
              'available' === this.currentTab
                ...
                : 'inuse' === this.currentTab
                  ...
                  : 'maintenance' === this.currentTab &&
                    this.renderTable('maintenanceTableBody', 'maintenanceEmpty', a));
            const r = 'available' === this.currentTab ? e : 'inuse' === this.currentTab ? t : a;
            ((document.getElementById('showingCount').textContent = r.length),
          ...
          renderTable(e, t, a) {
            ...
            if (0 === s.length)
              return (
                r.closest('.table-responsive').classList.add('d-none'),
                void (n && n.classList.remove('d-none'))
              );
            (r.closest('.table-responsive').classList.remove('d-none'),
            ...
            (s.forEach((e, t) => {
              ...
              (r.innerHTML = ''),
              r.appendChild(d),
              this.attachRowEventListeners(r));
          }
        ...
        R = new (class {
          ...
          async loadCategories() {
            try {
              ...
              e &&
                e.success &&
                e.data &&
                ((this.categories = e.data), this.populateCategoryDropdown());
            } catch (e) {}
          }
          populateCategoryDropdown() {
            ...
            e &&
              ...
              this.categories.forEach((t) => {
                const a = document.createElement('option');
                ((a.value = t.categoryId), (a.textContent = t.categoryName), e.appendChild(a));
              }));
          }
          setupEventListeners() {
            ...
            const t = document.getElementById('btnCancelAsset'),
              a = document.getElementById('btnBackToAssets');
            e &&
              (e.addEventListener('submit', (e) => {
                (e.preventDefault(), this.handleSubmit());
              }),
          ...
          getFormData() {
            ...
            const a = document.getElementById('purchasePrice').value;
            return (a && (e.purchasePrice = parseFloat(a)), e);
          }
          validateFormData(e) {
            return e.assetName
          ...
          async handleSubmit() {
            ...
            try {
              ...
              if (
                ...
                (a =
                  'update' === this.mode
                    ? await z.updateAsset(this.assetId, t)
                    : await z.createAsset(t)),
                !a || !a.success)
              )
                throw new Error(a.message || 'Failed to save asset');
              (alert(
                'update' === this.mode
              ...
              try {
                (await this.loadFromAPI(),
                  ...
                  window.showNotification &&
                    window.showNotification(
                      'success',
                      '✅ Categories refreshed successfully from API'
                    ));
              } catch (e) {
                window.showNotification &&
        ...
        async handleEdit(e) {
          this.categories.find((t) => t.id === e) &&
            (window.router
              ...
              : (sessionStorage.setItem('crudId', e),
      ...
      const $ = window.categoriesMenu,
        N = new (class {
          ...
          setupEventListeners() {
            ...
            const t = document.getElementById('btnCancelCategory'),
              a = document.getElementById('btnBackToCategories');
            e &&
              (e.addEventListener('submit', (e) => {
                (e.preventDefault(), this.handleSubmit());
              }),
          ...
          async handleSubmit() {
            ...
            try {
              ...
              if (
                ...
                (a =
                  'update' === this.mode
                    ? await z.updateCategory(this.categoryId, t)
                    : await z.createCategory(t)),
                !a || !a.success)
              )
                throw new Error(a.message || 'Failed to save category');
              (alert(
                'update' === this.mode
        ...
        q = new (class {
          ...
          async loadFromAPI() {
            try {
              this.loading = !0;
              const e = await z.getTransactions();
              e && e.success && e.data
          ...
          generateSampleTransactions() {
            const e = ['Checkout', 'Return', 'Transfer', 'Maintenance'],
              ...
              a = ['John Doe', 'Jane Smith', 'Bob Johnson', 'Warehouse'],
              r = ['Completed', 'Pending', 'Approved'];
            return Array.from({ length: 20 }, (n, i) => ({
              id: i + 1,
              ...
              from: a[Math.floor(Math.random() * a.length)],
              to: a[Math.floor(Math.random() * a.length)],
              status: r[Math.floor(Math.random() * r.length)],
            }));
          }
          async initialize() {
            (await this.loadFromAPI(),
          ...
          updateStats() {
            const e = new Date().toISOString().split('T')[0],
              ...
              a = this.transactions.filter((e) => 'Checkout' === e.type).length,
              r = this.transactions.filter((e) => 'Return' === e.type).length,
              n = this.transactions.filter((e) => 'Transfer' === e.type).length;
            ((document.getElementById('todayTransactions').textContent = t),
              (document.getElementById('checkoutCount').textContent = a),
              (document.getElementById('returnCount').textContent = r),
        ...
        F = new (class {
          ...
          async loadAssets() {
            try {
              const e = await z.getAssets();
              e && e.success && e.data && ((this.assets = e.data), this.populateAssetDropdown());
            } catch (e) {}
          }
          async loadEmployees() {
            try {
              const e = await z.getActiveEmployees();
              e &&
                e.success &&
                e.data &&
                ((this.employees = e.data), this.populateEmployeeDropdown());
            } catch (e) {}
          }
          populateAssetDropdown() {
            ...
            e &&
              ...
              this.assets.forEach((t) => {
                const a = document.createElement('option');
                ((a.value = t.assetId), (a.textContent = t.assetName), e.appendChild(a));
              }));
          }
          populateEmployeeDropdown() {
            ...
            e &&
              ...
              this.employees.forEach((t) => {
                const a = document.createElement('option');
                ((a.value = t.employeeId), (a.textContent = t.fullName), e.appendChild(a));
              }));
          }
          setupEventListeners() {
            ...
            const t = document.getElementById('btnCancelTransaction'),
              a = document.getElementById('btnBackToTransactions');
            e &&
              (e.addEventListener('submit', (e) => {
                (e.preventDefault(), this.handleSubmit());
              }),
          ...
          async loadTransaction(e) {
            try {
              const t = await z.getTransaction(e);
          ...
          getFormData() {
            ...
            const a = document.getElementById('transactionType').value;
            a && (e.transactionType = a);
            const r = document.getElementById('returnDate').value;
            r && (e.returnDate = new Date(r).toISOString());
            const n = document.getElementById('notes').value.trim();
            return (n && (e.notes = n), e);
          }
          validateFormData(e) {
            return e.assetId
          ...
          async handleSubmit() {
            ...
            try {
              ...
              if (
                ...
                (a =
                  'update' === this.mode
                    ? await z.updateTransaction(this.transactionId, t)
                    : await z.createTransaction(t)),
                !a || !a.success)
              )
                throw new Error(a.message || 'Failed to save transaction');
              (alert(
                'update' === this.mode
        ...
        U = new (class {
          ...
          async generateQuickReport(e) {
            (await E.show({
              ...
              message: `Generate ${e} Report?`,
              okText: 'Generate',
            })) &&
              (this.showNotification('success', `${e} Report generated successfully`),
              setTimeout(() => {
                const t = document.createElement('a');
                ((t.href = '#'), (t.download = `${e}-report.pdf`), t.click());
              }, 500));
          }
          async generateCustomReport() {
            const e = document.getElementById('reportType')?.value,
              t = document.getElementById('fromDate')?.value,
              a = document.getElementById('toDate')?.value;
            t && a
              ? (await E.show({
                  type: 'confirm',
                  title: 'Generate Custom Report',
                  message: `Generate ${e} from ${t} to ${a}?`,
                  okText: 'Generate',
        ...
        j = new (class {
          ...
          loadUserData() {
            ...
            return e
              ? JSON.parse(e)
              : { name: 'John Doe', email: 'john.doe@company.com', avatar: null };
          }
          setupEventListeners() {
            ...
            const a = document.getElementById('profileForm');
            a &&
              a.addEventListener('submit', (e) => {
                (e.preventDefault(), this.handleSaveProfile());
              });
            const r = document.getElementById('resetFormBtn');
            r &&
              r.addEventListener('click', (e) => {
                (e.preventDefault(), this.handleResetForm());
              });
            const n = document.getElementById('cancelProfileBtn');
            n &&
          ...
          handleSaveProfile() {
            const e = document.getElementById('firstName')?.value,
              ...
              a = document.getElementById('profileEmail')?.value;
            if (
              ...
              document.getElementById('profileTimezone'),
              !e || !t || !a)
            )
              return void this.showNotification('danger', '❌ Please fill in all required fields');
            const r = document.getElementById('saveProfileBtn');
            if (r) {
              const e = r.innerHTML;
              ((r.innerHTML = '<i class="fas fa-spinner fa-spin me-2"></i>Saving...'),
                (r.disabled = !0),
                setTimeout(() => {
                  ((r.innerHTML = e),
                    (r.disabled = !1),
          ...
          handleSavePassword(e) {
            const t = document.getElementById('currentPassword').value,
              ...
              r = document.getElementById('confirmPassword').value;
            t && a && r
              ? a === r
                ? a.length < 8
        ...
        H = new (class {
          ...
          setupEventListeners() {
            ...
            const a = document.getElementById('cancelSettingsBtn');
            a &&
              ((a.innerHTML = '<i class="fas fa-redo me-2"></i>Reset to Saved'),
        ...
        O = new (class {
          ...
          generateSampleData() {
            const e = [
              ...
              a = ['Engineering', 'Marketing', 'Sales', 'HR', 'Finance'],
              r = ['Active', 'Inactive'];
            return Array.from({ length: 50 }, (n, i) => ({
              id: i + 1,
              name: e[i % e.length],
              email: `employee${i + 1}@company.com`,
              position: t[Math.floor(Math.random() * t.length)],
              department: a[Math.floor(Math.random() * a.length)],
          ...
          setupEventListeners() {
            ...
            const a = document.getElementById('btnImport');
            a && a.addEventListener('click', () => this.handleImport());
            const r = document.getElementById('btnExport');
            r && r.addEventListener('click', () => this.handleExport());
            const n = document.getElementById('btnBatchDelete');
            n && n.addEventListener('click', () => this.handleBatchDelete());
            ...
            const s = document.getElementById('btnApplyFilters');
            s && s.addEventListener('click', () => this.applyFilters());
            const d = document.getElementById('btnResetFilters');
            d && d.addEventListener('click', () => this.resetFilters());
          }
          handleSearch(e) {
                  ...
                  '0-50000' === this.filters.salary
                    ...
                    : '50000-80000' === this.filters.salary
                      ...
                      : '80000-100000' === this.filters.salary
                        ? (t = t && a > 8e4 && a <= 1e5)
                        : '100000+' === this.filters.salary && (t = t && a > 1e5);
                }
                return t;
              })),
              (this.currentPage = 1),
          ...
          handleSelectAll(e) {
            const t = (this.currentPage - 1) * this.pageSize,
              a = t + this.pageSize,
              r = this.filteredData.slice(t, a);
            (e
              ? r.forEach((e) => this.selectedIds.add(e.id))
              : r.forEach((e) => this.selectedIds.delete(e.id)),
          ...
          async handleEdit(e) {
            ...
            t &&
              (await E.show({
                type: 'confirm',
                title: 'Edit Employee',
                message: `Edit information for ${t.name}?`,
                okText: 'Edit',
                cancelText: 'Cancel',
              })) &&
              ((window.location.hash = '#employeecrud'),
          ...
          exportToCSV(e = this.filteredData) {
            const t = [
              ...
              n = document.createElement('a');
            ((n.href = r),
              (n.download = `employees-${Date.now()}.csv`),
              n.click(),
          ...
          render() {
            ...
            if (!e) return;
            const a = (this.currentPage - 1) * this.pageSize,
              r = a + this.pageSize,
              n = this.filteredData.slice(a, r);
            if (0 === n.length)
              return (
            ...
            (e.closest('.table-responsive').classList.remove('d-none'),
          ...
          updateBatchButtons() {
            const e = document.getElementById('btnBatchDelete'),
              ...
              r = this.selectedIds.size > 0;
            (e && (e.disabled = !r),
              t && (t.disabled = !r),
              a &&
                (r
                  ? ((a.textContent = `${this.selectedIds.size} selected`),
          ...
          updateSelectAllCheckbox() {
            ...
            const t = (this.currentPage - 1) * this.pageSize,
              a = t + this.pageSize,
              r = this.filteredData.slice(t, a),
              n = r.length > 0 && r.every((e) => this.selectedIds.has(e.id));
            e.checked = n;
          }
          ...
          renderPagination() {
            ...
            let a = '';
            a += `<li class="page-item ${1 === this.currentPage ? 'disabled' : ''}">\n            <button class="page-link" data-page="${this.currentPage - 1}">Previous</button>\n        </li>`;
            for (let r = 1; r <= e; r++)
              1 === r || r === e || (r >= this.currentPage - 1 && r <= this.currentPage + 1)
                ? (a += `<li class="page-item ${r === this.currentPage ? 'active' : ''}">\n                    <button class="page-link" data-page="${r}">${r}</button>\n                </li>`)
                : (r !== this.currentPage - 2 && r !== this.currentPage + 2) ||
                  (a += '<li class="page-item disabled"><span class="page-link">...</span></li>');
            ((a += `<li class="page-item ${this.currentPage === e ? 'disabled' : ''}">\n            <button class="page-link" data-page="${this.currentPage + 1}">Next</button>\n        </li>`),
              (t.innerHTML = a),
              t.querySelectorAll('button[data-page]').forEach((t) => {
                t.addEventListener('click', () => {
                  const a = parseInt(t.dataset.page);
                  a >= 1 && a <= e && ((this.currentPage = a), this.render());
                });
              }));
          }
          showNotification(e, t) {
        ...
        V = new (class {
          ...
          validateField(e) {
            const t = e.id || e.name,
              a = e.value,
              r = this.validationRules[t];
            if (!r) return !0;
            let n = !0,
              i = '';
            if (
              (r.required && !a
                ? ((n = !1), (i = 'This field is required'))
                : r.minLength && a.length < r.minLength
                  ? ((n = !1), (i = `Minimum ${r.minLength} characters required`))
                  : r.min && parseFloat(a) < r.min
                    ? ((n = !1), (i = `Value must be at least ${r.min}`))
                    : r.pattern && !r.pattern.test(a) && ((n = !1), (i = 'Invalid format')),
              n)
            )
          ...
          handleSubmit() {
            ...
            const t = document.getElementById('saveProductBtn');
            if (t) {
              const e = t.innerHTML;
              ((t.innerHTML = '<i class="fas fa-spinner fa-spin me-2"></i>Saving...'),
                (t.disabled = !0),
                setTimeout(() => {
                  ((t.innerHTML = e),
                    (t.disabled = !1),
          ...
          async handleReset() {
            const { confirmModal: e } = await (function (e) {
              function t(e) {
                const t = new Event('vite:preloadError', { cancelable: !0 });
                if (((t.payload = e), window.dispatchEvent(t), !t.defaultPrevented)) throw e;
              }
              return Promise.resolve().then((a) => {
                for (const e of a || []) 'rejected' === e.status && t(e.reason);
                return e().catch(t);
              });
            })(async () => {
              const { confirmModal: e } = await Promise.resolve().then(() => I);
          ...
          loadSavedData() {
            ...
            e &&
              ...
              Object.keys(this.formData).forEach((e) => {
                const t = document.getElementById(e) || document.querySelector(`[name="${e}"]`);
          ...
          addAutoComplete() {
            ...
            if (e) {
              ...
              e.addEventListener('input', (e) => {
                ...
                a.length < 2 || t.filter((e) => e.toLowerCase().includes(a));
              });
            }
          }
      ...
      'undefined' != typeof window && (window.model2 = V);
      const _ = new (class {
        constructor() {
          ((this.charts = {}),
        ...
        generateSampleData() {
          ...
          for (let a = 6; a >= 0; a--) {
            ...
            (r.setDate(r.getDate() - a),
              e.push(r.toLocaleDateString('en-US', { month: 'short', day: 'numeric' })),
        ...
        initializeDateRange() {
          ...
          const a = document.getElementById('fromDate'),
            r = document.getElementById('toDate');
          (a && (a.valueAsDate = t), r && (r.valueAsDate = e));
        }
        setupEventListeners() {
          ...
          (t && t.addEventListener('click', () => this.exportAllCharts()),
            ['Line', 'Pie', 'Bar', 'Radar'].forEach((e) => {
              const t = document.getElementById(`btnExport${e}Chart`);
              t && t.addEventListener('click', () => this.exportChart(e.toLowerCase()));
            }));
          const a = document.getElementById('quickDateRange');
          a && a.addEventListener('change', (e) => this.handleQuickDateRange(e.target.value));
          const r = document.getElementById('btnApplyDateRange');
          r && r.addEventListener('click', () => this.applyDateRange());
          const n = document.getElementById('realTimeToggle');
          n &&
          ...
          this.charts.line = new Chart(t, {
            ...
            options: {
              ...
              plugins: {
                legend: { display: !0 },
                tooltip: {
                  callbacks: { label: (e) => `Revenue: $${e.parsed.y.toLocaleString()}` },
                },
              },
              scales: {
                y: { beginAtZero: !0, ticks: { callback: (e) => '$' + e.toLocaleString() } },
              },
            },
          });
        }
        ...
        refreshAllCharts() {
          ((this.currentData = this.generateSampleData()),
            Object.keys(this.charts).forEach((e) => {
              this.charts[e] &&
                ((this.charts[e].data.labels =
                  this.currentData.labels || this.charts[e].data.labels),
        ...
        exportChart(e) {
          ...
          if (!t) return;
          const a = t.toBase64Image(),
            r = document.createElement('a');
          ((r.download = `chart-${e}-${Date.now()}.png`),
            (r.href = a),
            r.click(),
            this.showNotification(
              'success',
              `${e.charAt(0).toUpperCase() + e.slice(1)} chart exported`
            ));
        }
        exportAllCharts() {
          (Object.keys(this.charts).forEach((e) => {
        ...
        handleQuickDateRange(e) {
          ...
          ((document.getElementById('fromDate').valueAsDate = a),
          ...
          this.realTimeInterval ||
            (this.realTimeInterval = setInterval(() => {
              const e = document.getElementById('liveUsers'),
                ...
                a = document.getElementById('liveRevenue');
              (e && (e.textContent = Math.floor(100 * Math.random()) + 150),
                t && (t.textContent = Math.floor(10 * Math.random()) + 5),
                a && (a.textContent = (500 * Math.random() + 200).toFixed(2)),
                (e && t && a) || this.stopRealTimeUpdates());
            }, 2e3));
        }
        stopRealTimeUpdates() {
          this.realTimeInterval &&
            (clearInterval(this.realTimeInterval), (this.realTimeInterval = null));
        }
        showNotification(e, t) {
          window.showNotification && window.showNotification(e, t);
        }
            ...
            e.forEach((e) => {
              ...
              (e.parentNode.replaceChild(t, e),
                t.addEventListener('click', function (e) {
                  ...
                  if (!a) return;
                  const r = this.querySelector('i, .fa-eye, .fa-eye-slash');
                  'password' === a.type
                    ? ((a.type = 'text'),
                      r && (r.classList.remove('fa-eye'), r.classList.add('fa-eye-slash')))
                    : ((a.type = 'password'),
        ...
        new (class {
          ...
          init() {
            document.addEventListener('click', (e) => {
              ...
              if (t) {
                e.preventDefault();
                const a = t.getAttribute('data-route');
                window.router ? window.router.navigate(a) : (window.location.href = '/' + a);
              }
            });
          }
        })());
      const Y = new (class {
        ...
        async initializeServices() {
          (h.init(),
            s.on('auth:login-success', ({ user: e }) => {
              (p.setUser(e), g.navigate('dashboard'));
            }),
            s.on('auth:logout', () => {
              (p.clear(!0), g.navigate('login'));
            }),
            s.on('auth:session-expired', () => {
              (f.warning('Your session has expired. Please login again.'), g.navigate('login'));
            }),
            s.on('notification:success', (e) => {
              f.success(e);
            }),
            s.on('notification:error', (e) => {
              f.error(e);
            }),
            s.on('notification:warning', (e) => {
              f.warning(e);
            }),
            s.on('notification:info', (e) => {
              f.info(e);
            }));
        }
        async loadLayouts() {
          try {
            const e = await fetch('/layouts/sidebar.html'),
              t = await e.text(),
              a = document.getElementById('sidebar-container');
            a && (a.innerHTML = t);
            const r = await fetch('/layouts/topbar.html'),
              n = await r.text(),
        ...
        setupGlobalEvents() {
          ...
          (window.addEventListener('resize', () => {
            (clearTimeout(e),
              (e = setTimeout(() => {
                s.emit('window:resized', { width: window.innerWidth, height: window.innerHeight });
              }, 250)));
          }),
            document.addEventListener('visibilitychange', () => {
              s.emit('page:visibility-changed', { hidden: document.hidden });
            }),
            window.addEventListener('beforeunload', (e) => {
              s.emit('app:before-unload');
            }),
        ...
        setupUIHandlers() {
          (document.addEventListener('click', (e) => {
            ...
            document.addEventListener('click', (e) => {
              e.target.closest('[data-action="toggle-search"]') && (e.preventDefault(), x.show());
            }),
            document.addEventListener('click', (e) => {
            ...
            document.addEventListener('click', (e) => {
              (e.target.closest('[data-action="lock-screen"]') && (e.preventDefault(), b.lock()),
            ...
            document.addEventListener('click', (e) => {
              ...
              if (t) {
                ...
                (document.querySelectorAll('.has-submenu.open').forEach((e) => {
                  ...
                  n || (a.classList.add('open'), r && r.classList.add('show')));
              }
            }));
        }
        initializeTheme() {
        ...
        toggleSidebar() {
          ...
          window.innerWidth <= 1024
            ...
            : (e?.classList.toggle('collapsed'),
              a.classList.toggle('sidebar-collapsed'),
              p.toggleSidebar());
        }
        toggleTheme() {
        ...
        toggleFullscreen() {
          document.fullscreenElement
            ...
            : document.documentElement.requestFullscreen().catch((e) => {
                f.error(`Error attempting to enable fullscreen: ${e.message}`);
              });
        }
        handleEscape() {
          (document.querySelectorAll('.modal.show').forEach((e) => {
            ...
            window.innerWidth <= 1024 &&
              document.querySelector('.sidebar-container.show') &&
              this.toggleSidebar());
        }
        async handleLogout() {
          try {
            (await h.logout(), f.success('Logged out successfully'));
          } catch (e) {
            f.error('Logout failed');
          }
        }
        showLoadingScreen() {
          document.body.insertAdjacentHTML(
      ...
      ('loading' === document.readyState
        ? document.addEventListener('DOMContentLoaded', () => Y.init())
        : Y.init(),
        (window.RedAdminApp = Y));
    },
  };
});
