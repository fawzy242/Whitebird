...
export class DashboardMenu {
    ...
    generateRecentOrders() {
        ...
        const orders = [
            { id: '#1847', customer: 'John Doe', product: 'Laptop Pro X1', amount: '$1,299', status: 'Delivered', date: '2024-12-10' },
            { id: '#1846', customer: 'Jane Smith', product: 'Wireless Mouse', amount: '$29', status: 'Processing', date: '2024-12-10' },
            { id: '#1845', customer: 'Bob Johnson', product: 'USB-C Cable', amount: '$15', status: 'Shipped', date: '2024-12-09' },
            { id: '#1844', customer: 'Alice Brown', product: 'Monitor 27"', amount: '$399', status: 'Delivered', date: '2024-12-09' },
            { id: '#1843', customer: 'Charlie Wilson', product: 'Keyboard RGB', amount: '$89', status: 'Cancelled', date: '2024-12-08' }
        ];
