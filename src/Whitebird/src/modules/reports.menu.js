...
export class ReportsMenu {
    constructor() {
        this.recentReports = [
            ...
            { name: 'Employee Records Nov 2024', type: 'Employee', generated: '2024-11-30', by: 'HR Manager' },
            { name: 'Transaction History Q3', type: 'Transaction', generated: '2024-10-15', by: 'Accountant' }
        ];
    }
    ...
    setupEventListeners() {
        // Quick reports
        document.getElementById('btnAssetReport')?.addEventListener('click', () => 
            this.generateQuickReport('Asset Inventory'));
        document.getElementById('btnEmployeeReport')?.addEventListener('click', () => 
            this.generateQuickReport('Employee'));
        document.getElementById('btnTransactionReport')?.addEventListener('click', () => 
            this.generateQuickReport('Transaction'));
        document.getElementById('btnFinancialReport')?.addEventListener('click', () => 
            this.generateQuickReport('Financial'));
    ...
    render() {
        ...
        const html = this.recentReports.map(report => `
            <tr>
