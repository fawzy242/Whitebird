...
class PageInitializer {
    ...
    shouldReinitialize(pageName) {
        ...
        const alwaysReinit = ['employeecrud', 'assetcrud', 'categorycrud', 'transactioncrud', 
                              'dashboard', 'model1', 'model3'];
        
        // Pages that only initialize once (static lists, settings)
        const initOnce = ['employees', 'assets', 'categories', 'transactions', 
                         'reports', 'model2', 'profile', 'settings', 'components', 'buttons'];
        ...
        toggleButtons.forEach(button => {
            ...
            newButton.addEventListener('click', function(e) {
                ...
                const passwordInput = inputGroup ? 
                    ...
                    this.previousElementSibling || this.parentElement.querySelector('input[type="password"], input[type="text"]');
